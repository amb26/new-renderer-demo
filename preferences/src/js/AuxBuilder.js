            ...
            fluid.each(map, function (primaryPath, internalPath) {
                if (fluid.prefs.checkPrimarySchema(prefSchema, prefKey)) {
                    ...
                    if (internalPath.indexOf("model.") === 0 && primaryPath === "value") {
                        ...
                        // TODO: But of course it doesn't, it sets up a bunch of model relay stuff directly,
                        // and "rules" is just a funny thing initialised by an expander for "subpanels"
