...
fluid.defaults("fluid.tests.textfield", {
    gradeNames: ["fluid.textfield", "fluid.ariaLabelledBy", "fluid.directAriaLabel"],
    model: {
        value: "default value",
        messages: {
            label: "Aria Label"
    ...
    ariaLabelledBy: "label-textfield"
});
...
fluid.defaults("fluid.tests.textfield.rangeController", {
    gradeNames: ["fluid.textfield.withRangeController", "fluid.directAriaLabel"],
    model: {
        value: 0
    },
