...
fluid.tests.textfieldControl.assertTextfieldInit = function (that, expected) {
    ...
    jqUnit.assertEquals("The aria-label should be set", that.model.messages.label, textfield.attr("aria-label"));
    jqUnit.assertEquals("The aria-labelledby should be set", that.options.ariaLabelledBy, textfield.attr("aria-labelledby"));
};
