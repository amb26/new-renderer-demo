        ...
        dom: {
            control: {
                attr: {
                    ...
                    "aria-label": "{that}.model.messages.label",
...
fluid.tests.switchUI.assertInit = function (that) {
    ...
    jqUnit.assertEquals("The aria-label is set", that.model.messages.label, control.attr("aria-label"));
    jqUnit.assertEquals("The aria-labelledby is set", "label", control.attr("aria-labelledby"));
    jqUnit.assertEquals("The on text is set", that.model.messages.on, that.locate("on").text());
    jqUnit.assertEquals("The off text is set", that.model.messages.off, that.locate("off").text());
};
